...
add(10,20);
//optional parameter 
function empDetails(id:number,name:string,salary?:number,age?:number){
...
function customerDetails(cid:number,cname?:string,age:number=18,city:string="Bangalore"){
...
//function with any return type or may not return. by default any type consider 
function info(a:number):any{
        if(a>100){
            return true;
        }else {
            return "No";
